      ...
      <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data">
          ...
          <?php 
                if(isset($_POST['enviar'])): 
                    ...
                    $extensao = pathinfo($_FILES['escolherarquivo']['name'], PATHINFO_EXTENSION);
                    if(in_array($extensao, $formatosPermitidos)):
                        $pasta = "uploads/";
                        $temporario = $_FILES['escolherarquivo']['tmp_name'];
                ...
                <div class="custom-file">
                    <input type="file" class="custom-file-input" name="escolherarquivo" required>
